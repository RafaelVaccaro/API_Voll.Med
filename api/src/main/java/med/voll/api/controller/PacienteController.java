...
public class PacienteController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity cadastrar(@RequestBody @Valid DadosCadastroPaciente dados, UriComponentsBuilder uriCBuilder) {
        Paciente paciente = new Paciente(dados);
        repository.save(new Paciente(dados));
        var uri = uriCBuilder.path("/pacientes/{id}").buildAndExpand(paciente.getId()).toUri();
